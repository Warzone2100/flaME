Public Class clsBooleanMap
    ...
    Sub Blank(ByVal SizeX As Integer, ByVal SizeY As Integer)
    ...
    Sub SizeCopy(ByVal Source As clsBooleanMap)
    ...
    Sub Copy(ByVal Source As clsBooleanMap)
        Dim X As Integer
        Dim Y As Integer
    ...
    Sub Convert_Heightmap(ByVal Source As clsHeightmap, ByVal AtOrAboveThisHeightEqualsTrue As Long)
        Dim X As Integer
        Dim Y As Integer
    ...
    Sub Expand_One_Tile(ByVal Source As clsBooleanMap)
        Dim X As Integer
        Dim Y As Integer
    ...
    Sub Remove(ByVal Source As clsBooleanMap, ByVal Remove As clsBooleanMap)
        Dim X As Integer
        Dim Y As Integer
    ...
    Sub Combine(ByVal Source As clsBooleanMap, ByVal Insert As clsBooleanMap)
        Dim X As Integer
        Dim Y As Integer
    ...
    Sub Within(ByVal Interior As clsBooleanMap, ByVal Exterior As clsBooleanMap)
        Dim Y As Integer
        Dim X As Integer
        Dim Flag As Boolean
